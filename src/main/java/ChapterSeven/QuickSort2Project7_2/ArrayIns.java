...
class ArrayIns
{
    ...
    private int countOfcopies = 0;  //Счетчик копирования
    private int countOfCompares = 0; //Счетчик сравнений
    private int countOfSwaps = 0; //Счетчик свапов(3 копирования)
    //--------------------------------------------------------------
    ...
    public void display() // Вывод содержимого массива
    {
        ...
        System.out.println("");
        System.out.println("Count of copies: " + countOfcopies);
        System.out.println("Count of compares: " + countOfCompares);
        System.out.println("Count of swaps: " + countOfSwaps);
        countOfSwaps = 0;
        countOfCompares = 0;
        countOfcopies = 0;
    }
